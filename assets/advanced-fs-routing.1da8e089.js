var h=Object.defineProperty,m=Object.defineProperties;var f=Object.getOwnPropertyDescriptors;var n=Object.getOwnPropertySymbols;var o=Object.prototype.hasOwnProperty,p=Object.prototype.propertyIsEnumerable;var d=(a,t,i)=>t in a?h(a,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):a[t]=i,r=(a,t)=>{for(var i in t||(t={}))o.call(t,i)&&d(a,i,t[i]);if(n)for(var i of n(t))p.call(t,i)&&d(a,i,t[i]);return a},g=(a,t)=>m(a,f(t));var c=(a,t)=>{var i={};for(var l in a)o.call(a,l)&&t.indexOf(l)<0&&(i[l]=a[l]);if(a!=null&&n)for(var l of n(a))t.indexOf(l)<0&&p.call(a,l)&&(i[l]=a[l]);return i};import{c as e,L as s}from"./clientRender.7d513ba0.js";const y={},P="wrapper";function u(i){var l=i,{components:a}=l,t=c(l,["components"]);return e(P,g(r(r({},y),t),{components:a,mdxType:"MDXLayout"}),e("h2",null,"Advanced Filesystem Routing: pageStrategy API"),e("blockquote",null,e("p",{parentName:"blockquote"},`The "Basic Filesystem Routing Convention" should satisfy most users' needs. `,e("strong",{parentName:"p"},"You probably don't need to read this advanced guide"),".")),e("p",null,"For advanced users, vite-pages let you implement your own filesystem routing convention: you can ",e("strong",{parentName:"p"},"teach vite-pages how to collect page data from your project"),"."),e("p",null,"When ",e("a",{parentName:"p",href:"https://github.com/vitejs/vite-plugin-react-pages/blob/master/packages/create-project/template-lib/vite.config.ts"},"configuring vite-plugin-react-pages"),", you can pass the ",e("inlineCode",{parentName:"p"},"pageStrategy")," option. It should be an instance of ",e("inlineCode",{parentName:"p"},"PageStrategy")," class. Here is an example of customizing pageStrategy:"),e("pre",null,e("code",{parentName:"pre",className:"language-ts"},`// vite.config.ts
...
`)),e("p",null,e("a",{parentName:"p",href:"https://github.com/vitejs/vite-plugin-react-pages/blob/master/packages/react-pages/src/node/dynamic-modules/DefaultPageStrategy/index.ts"},"Here is the complete definition of DefaultPageStrategy"),". And ",e(s,{to:"/examples/component-library",mdxType:"Link"},"here is an example of using it"),"."),e("h4",null,"Examples"),e("p",null,"For real-life examples of customizing pageStrategy, checkout ",e(s,{to:"/examples/component-library",mdxType:"Link"},'"Example: develop a component library"'),"."),e("h4",null,"Types"),e("p",null,"Here is the relavent types:"),e("pre",null,e("code",{parentName:"pre",className:"language-ts"},`type FindPages = (
  pagesDir: string,
  helpers: PageHelpers
) => void | Promise<void>
...
`)))}u.isMDXComponent=!0;var b=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:u});const v={};v.main=b;export{v as default};
